...
def find_final_holder(eq_row: dict, holder: dict, date: datetime) -> dict:
    if holder['id'] != 1 and is_transfered(eq_row, holder, date):
...
def add_into_dict(source: dict, value: dict):
    if value[1] not in source:
